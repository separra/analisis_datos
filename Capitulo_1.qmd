...
Antes de la aplicación de la estadísitica inferencial, es necesario corrobar el la distribución de cada una de las variables numéricas, esto con el objetivo de visualizar su comportamiento y por tanto corroborar si los métodos a emplear serán paramétricos o no paramétricos. Para esto se emplean diagramas de distribución de frecuencias y de cuantíles.
...
Los frutos de Capsicum fueron evaluados en fresco, antes de someter las muestras al proceso de conservación con ácido acético.
